...
<?php if(is_front_page()) { ?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footerLogos">
			<img src="<?php bloginfo('stylesheet_directory'); ?>/img/datcp.png" alt="Wisconsin Department of Agriculture, Trade and Consumer Protection logo" id="datcpIMG">
			<img src="<?php bloginfo('stylesheet_directory'); ?>/img/cals.svg" alt="UW-Madison College of Agriculture & Life Sciences" id="calsIMG">
